...
//         //========children
//         cout << line;
//         commandsInstance.children(expectedName1_2);
//         //========child
//         cout << line;
//         commandsInstance.child(expectedName0_1, 1);
//         cout << line;
//         commandsInstance.child(expectedName0_1, 2);
//         //========text
//         cout << line;
//         commandsInstance.text(expectedName1_2);
//         //========delete attribute
//         cout << line;
//         commandsInstance.deleteAttribute(expectedName0_1, temp_id);
//         std::cout << line;
//         commandsInstance.select1(expectedName0_1, temp_id);
//         //========new child
//         cout << line;
//         commandsInstance.newchild("salamcho");
//         cout << line;
//         std::cout << pr.getRoot();
